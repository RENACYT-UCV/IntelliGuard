...
class PertenenciasService:
    ...
    def consultar_pertenencias_estudiante_busqueda(datosEstudainte, estadoRegistros, codigoPertenencia):
        try:
            base_datos_pertenencia = BaseDatosPertenencia("basededatos.db")
            pertenencias = base_datos_pertenencia.consultar_pertenencias_estudiante_busqueda(datosEstudainte, estadoRegistros, codigoPertenencia)
            registros_dic = []
